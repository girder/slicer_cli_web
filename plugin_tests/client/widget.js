...
girderTest.addCoveredScripts([
    '/plugins/slicer_cli_web/web_client/js/0init.js',
    '/plugins/slicer_cli_web/web_client/js/models/widget.js',
    '/plugins/slicer_cli_web/web_client/js/parser.js',
    '/plugins/slicer_cli_web/web_client/js/views/0panel.js',
    '/plugins/slicer_cli_web/web_client/js/views/controlsPanel.js',
    '/plugins/slicer_cli_web/web_client/js/views/controlWidget.js',
    '/plugins/slicer_cli_web/web_client/js/views/itemSelectorWidget.js',
    '/plugins/slicer_cli_web/web_client/js/views/panelGroup.js',
    '/clients/web/static/built/plugins/slicer_cli_web/templates.js'
]);

describe('widget model', function () {
    // test different widget types
    it('range', function () {
        var w = new slicer.models.Widget({
            type: 'range',
            title: 'Range widget',
            min: -10,
            max: 10,
...
describe('widget collection', function () {
    it('values', function () {
        var c = new slicer.collections.Widget([
